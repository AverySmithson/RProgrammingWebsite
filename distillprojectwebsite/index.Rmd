...
2. the first layer is the dataset
3. the second layer are the coordinates 
4. the third layer are the geoms, which are what we choose to visualize our data points
